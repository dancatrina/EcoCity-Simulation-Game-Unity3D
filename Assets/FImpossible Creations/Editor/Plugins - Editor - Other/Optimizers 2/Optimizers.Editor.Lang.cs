...
namespace FIMSpace.FOptimizing
{
    ...
    {
        private TextAsset langFile { get { if (_langFile == null) _langFile = Resources.Load("FIMSpace/Optimizers 2/OptimizersLangs") as TextAsset; return _langFile; } }
        ...
        private void SetupLangs()
        {
            ...
            if (langFile == null)
            {
                Debug.Log("<color=red>[Optimizers] No lang file!</color> You moved it from Editor/Resources/Optimizers/ ???");
                return;
            }
        ...
        protected string Lang(string title)
        {
            if (langTexts == null)
            {
