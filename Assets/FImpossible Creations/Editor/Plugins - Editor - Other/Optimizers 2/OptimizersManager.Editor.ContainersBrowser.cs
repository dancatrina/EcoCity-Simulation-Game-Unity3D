    ...
    public partial class Optimizer_EditorManager : Editor
    {
        ...
        void DrawContainersBrowser()
        {
            ...
            else
            {
                ...
                int contListsCount = 0;
                if (m.CullingContainersIDSpecific != null) contListsCount = m.CullingContainersIDSpecific.Count;
                    ...
                    if (drawOptimList)
                    {
                        ...
                        for (int i = 0; i < cont.Optimizers.Length; i++)
                        {
                            if (cont.Optimizers[i] != null)
                            {
                                ...
                                //EditorGUILayout.LabelField("(Id: " + cont.Optimizers[i].GetInstanceID() + ")");
