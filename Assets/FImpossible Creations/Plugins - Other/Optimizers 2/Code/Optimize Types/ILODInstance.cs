...
namespace FIMSpace.FOptimizing
{
    ...
    public interface ILODInstance
    {
        ...
        /// <summary> Making settings unoverridable </summary>
        ...
        /// <summary> Used for custom inspector window </summary>
        void DrawVersionSwitch(UnityEditor.SerializedProperty iflodProp, LODsControllerBase lODsControllerBase);

        /// <summary> Used for custom inspector window </summary>
        void CustomEditorWindow(UnityEditor.SerializedProperty iflodProp, LODsControllerBase lODsControllerBase);
#endif
